...
const translations: Record<Language, Translations> = {
  fr: {
    ...
    // Nos Moments
    nosMoments: 'Nos Moments',
    nosMomentsDesc: 'Partagez vos souvenirs',
    addPhoto: 'Ajouter',
    noPhotosYet: 'Aucune photo',
    captureMemories: 'Capturez vos moments ensemble',
  ...
  en: {
    ...
    // Nos Moments
    nosMoments: 'Our Moments',
    nosMomentsDesc: 'Share your memories',
    addPhoto: 'Add',
    noPhotosYet: 'No photos yet',
    captureMemories: 'Capture your moments together',
